  ...
  <div class="c-social">
    ...
    <ul class="c-social-links">
      <li class="c-social-links__item">
        <a
          href="https://www.linkedin.com/in/devanshi1500"
          target="_blank"
          rel="noopener"
        >
          <svg
          ...
          <span class="c-social-links__label">LinkedIn</span>
        </a>
      </li>
      <li class="c-social-links__item">
        <a href="mailto:devanshi1500@gmail.com" target="_blank" rel="noopener">
          <svg
            class="c-social-links__icon"
            width="24"
            height="24"
          ...
          <span class="c-social-links__label">Email</span>
        </a>
      </li>
      <li class="c-social-links__item">
        <a
          href="https://www.github.com/devanshi1500"
          target="_blank"
          rel="noopener"
        >
          <svg
      ...
      <li class="c-social-links__item">
        <a
          href="https://www.twitter.com/devanshi1500"
          target="_blank"
          rel="noopener"
        >
          <svg
